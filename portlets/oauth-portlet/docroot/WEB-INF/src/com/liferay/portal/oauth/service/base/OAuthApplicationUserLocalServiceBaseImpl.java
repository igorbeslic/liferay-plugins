...
/**
 * The base implementation of the o auth application user local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.portal.oauth.service.impl.OAuthApplicationUserLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class OAuthApplicationUserLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements OAuthApplicationUserLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.portal.oauth.service.OAuthApplicationUserLocalServiceUtil} to access the o auth application user local service.
	 */
	...
	public OAuthApplicationUser addOAuthApplicationUser(
		OAuthApplicationUser oAuthApplicationUser) throws SystemException {
		oAuthApplicationUser.setNew(true);

		return oAuthApplicationUserPersistence.update(oAuthApplicationUser,
			false);
	}
	 ...
	 */
	public OAuthApplicationUser createOAuthApplicationUser(long oaauId) {
		return oAuthApplicationUserPersistence.create(oaauId);
	}
	...
	public OAuthApplicationUser deleteOAuthApplicationUser(long oaauId)
		throws PortalException, SystemException {
		return oAuthApplicationUserPersistence.remove(oaauId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public OAuthApplicationUser deleteOAuthApplicationUser(
		OAuthApplicationUser oAuthApplicationUser) throws SystemException {
		return oAuthApplicationUserPersistence.remove(oAuthApplicationUser);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(OAuthApplicationUser.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return oAuthApplicationUserPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return oAuthApplicationUserPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public OAuthApplicationUser fetchOAuthApplicationUser(long oaauId)
		throws SystemException {
		return oAuthApplicationUserPersistence.fetchByPrimaryKey(oaauId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public OAuthApplicationUser getOAuthApplicationUser(long oaauId)
		throws PortalException, SystemException {
		return oAuthApplicationUserPersistence.findByPrimaryKey(oaauId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return oAuthApplicationUserPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<OAuthApplicationUser> getOAuthApplicationUsers(int start,
		int end) throws SystemException {
		return oAuthApplicationUserPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getOAuthApplicationUsersCount() throws SystemException {
		return oAuthApplicationUserPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public OAuthApplicationUser updateOAuthApplicationUser(
		OAuthApplicationUser oAuthApplicationUser) throws SystemException {
		return updateOAuthApplicationUser(oAuthApplicationUser, true);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.portal.oauth.model.OAuthApplicationUser",
			oAuthApplicationUserLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = oAuthApplicationUserPersistence.getDataSource();
	...
	private OAuthApplicationUserLocalServiceClpInvoker _clpInvoker = new OAuthApplicationUserLocalServiceClpInvoker();
}