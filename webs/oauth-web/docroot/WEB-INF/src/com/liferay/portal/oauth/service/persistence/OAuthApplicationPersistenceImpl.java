...
public class OAuthApplicationPersistenceImpl extends BasePersistenceImpl<OAuthApplication>
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_NAME = new FinderPath(OAuthApplicationModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { String.class.getName() });
	public static final FinderPath FINDER_PATH_FETCH_BY_OWNERID = new FinderPath(OAuthApplicationModelImpl.ENTITY_CACHE_ENABLED,
			OAuthApplicationModelImpl.FINDER_CACHE_ENABLED,
			OAuthApplicationImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByownerId", new String[] { Long.class.getName() },
	...
	public void cacheResult(OAuthApplication oAuthApplication) {
		...
		FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_OWNERID,
			new Object[] { Long.valueOf(oAuthApplication.getOwnerId()) },
			oAuthApplication);
	...
	protected void clearUniqueFindersCache(OAuthApplication oAuthApplication) {
		FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_OWNERID,
			new Object[] { Long.valueOf(oAuthApplication.getOwnerId()) });
	}
	 ...
	 */
	public OAuthApplication remove(long id)
	...
	protected OAuthApplication toUnwrappedModel(
		...
		oAuthApplicationImpl.setId(oAuthApplication.getId());
		...
		oAuthApplicationImpl.setSecret(oAuthApplication.getSecret());
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public OAuthApplication findByPrimaryKey(long id)
		throws NoSuchApplicationException, SystemException {
		OAuthApplication oAuthApplication = fetchByPrimaryKey(id);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public OAuthApplication fetchByPrimaryKey(long id)
		throws SystemException {
		...
		if (oAuthApplication == null) {
			...
			try {
				...
				if (oAuthApplication != null) {
					...
					EntityCacheUtil.putResult(OAuthApplicationModelImpl.ENTITY_CACHE_ENABLED,
						OAuthApplicationImpl.class, id, _nullOAuthApplication);
				}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public OAuthApplication[] findByname_PrevAndNext(long id, String name,
		OrderByComparator orderByComparator)
		throws NoSuchApplicationException, SystemException {
		OAuthApplication oAuthApplication = findByPrimaryKey(id);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public OAuthApplication findByownerId(long ownerId)
		throws NoSuchApplicationException, SystemException {
		OAuthApplication oAuthApplication = fetchByownerId(ownerId);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public OAuthApplication fetchByownerId(long ownerId)
		throws SystemException {
	...
	public OAuthApplication fetchByownerId(long ownerId,
		...
		if (retrieveFromCache) {
			result = FinderCacheUtil.getResult(FINDER_PATH_FETCH_BY_OWNERID,
					finderArgs, this);
		}
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((oAuthApplication.getOwnerId() != ownerId)) {
						FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_OWNERID,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public OAuthApplication[] findBywebsite_PrevAndNext(long id,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public OAuthApplication removeByownerId(long ownerId)
		throws NoSuchApplicationException, SystemException {
		OAuthApplication oAuthApplication = findByownerId(ownerId);
